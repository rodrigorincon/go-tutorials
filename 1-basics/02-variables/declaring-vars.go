...
func main() {
    ...
    ////// defining a var but printing without setting
    ...
    ////// You can't define a var and don't use it. It'll break no compile
    // var my_var string
    // if I dno't use this var, the compilation will break
}